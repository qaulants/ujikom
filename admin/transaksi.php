        ...
        <div class="container-fluid">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    <h3 class="card-header m-0 font-weight-bold text-primary">Transaksi Laundry</h3>
                                    <div class="card-body">
                                            ...
                                            <tbody>
                                                ...
                                                while ($rowTrans = mysqli_fetch_assoc($queryTrans)) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="tambah-transaksi.php?detail=<?php echo $rowTrans['id'] ?>" class="btn btn-primary btn-sm">
                                                            ...
                                                            <a onclick="return confirm('Apakah anda yakin akan menghapus data ini?')"
                                                                href="transaksi.php?delete=<?php echo $rowTrans['id'] ?>" class="btn btn-danger btn-sm">
